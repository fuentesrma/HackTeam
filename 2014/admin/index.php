...
<body>
	<div class="contenido">
		...
		<div class="container">
			...
			<td><button class="md-trigger" data-modal="modal-1">Nuevo Producto</button></td>
...
if ($_POST) {
		...
		$marca = $_POST['marca'];
 		...
 		$Nuevo = new Producto();
 		$Nuevo -> Nuevo($id_prod,$nomb_prod,$desc_prod,$precio_prod,$stock,$categoria,$id_prod,$marca);
 	}
 	if ($_GET) {
 		$id_prod=$_GET['id-kei'];

 		$Eliminar = new Producto();
 		$Eliminar -> Eliminar($id_prod);
